...
void _ntTuiDrawFrame(RLRectangle r, Color col, const char *description);

// draw frame with double lines
// `description` can be NULL, In this case text would be displayed
void _ntTuiDrawFrameDouble(RLRectangle r, Color col, const char *description);
...
// `description` can be NULL, in this case text would not be displayed
void _ntTuiDrawFrameEx(RLRectangle r, Color col, const char **mapping, const char *description);
